...
const Item1 = (products)=> {
    ...
    return(
        <div className="m-d-b">
              <Link onClick={ScrollToTop} className="m-p-b" to={`${process.env.URL_STATE}/products/${products.item.id}`}>
                <div className="m-i-1-1">
                  <img loading="lazy" src={products.item.image?process.env.URL_STATE + products.item.image:process.env.URL_STATE+"/images/first-aid-alt.svg"} alt="Panakea 1" className="m-i" />
                </div>
                <div className="m-t-p">
                  ...
                  <div className="l-t-p">
                    ...
                    <div className="m-l-p">
                      ...
                      <div className="p-p">
                        <div className="i-p-1">
                          <img loading="lazy" src={process.env.URL_STATE+"/images/shopping-basket-add.svg"} alt="Panakea 1" className="p" />
                        </div>
                      </div>
                    </div>
                  </div>
